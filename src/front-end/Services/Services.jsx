                                    ...
                                    ServiceType.MOVING ? (
                                        ...
                                        <div className="moving-search-box house-cleaning-sec">
                                            ...
                                            <div className="text-center mt-0 mx-3">
                                                <div className="button-common mt-5 w-100">
                                                    Get a Price
                                                </div>
                                            </div>
                                            ...
                                            <div className="moving-des mt-5">
                                                ...
                                                <p className="text-center">
                                                    By signing and clicking Get
                                                    a Price, you affirm you have
                                                    read and agree to the Handy
                                                    Terms, and you agree and
                                                    authorize Handy and its
                                                    ...
                                                    above regarding your project
                                                    and other home services
                                                    offers. Consent is not a
