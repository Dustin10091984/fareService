                                ...
                                <div className="moving-search-box">
                                    ...
                                    <div className="d-flex justify-content-between">
                                        <div className="m-search-left-box">
                                            ...
                                            <div className="common-input">
                                                <textarea
                                                    ...
                                                    cols="30"
                                                    rows="10"
                                                    placeholder="descripe the job in details..."
                                                ></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div className="m-search-right-box">
                                            <div className="sub-label text-center mb-4">
                                            ...
                                            <div className="sub-label text-center mb-4 pt-4">
                                    ...
                                    <div className="moving-des mt-5">
                                        ...
                                        <br />
                                        <p className="text-center">
                                            If you're moving to a new home or
                                            relocating your office, you're
                                            probably worried about how you're
                                            going to get it all done. Luckily,
                                            Farenow is here to help. When you
                                            book moving help through the Farenow
                                            platform, you'll save time, money
                                            and the inevitable stress that comes
                                            with any big move. Farenow will
                                            connect you with local house movers
                                            who have the skill, experience, and
                                            equipment to make your house move go
                                            as smoothly as possible. You're
                                            responsible for providing your own
                                            moving van or truck, but once you've
                                            figured that out, Farenow will help
                                            you figure out the rest. We will
                                            help you find professional furniture
                                            movers who can help with everything,
                                            from the initial packing and
                                            wrapping to heavy lifting and
                                            unpacking once you reach your final
                                            destination.
                                        </p>
                                        <br />
                                        <br />
                                        ...
                                        <strong className="text-center">
                                            Note: This service is for moving
                                            help, including packing boxes,
                                            unpacking boxes, heavy lifting, and
                                            loading items into a vehicle. It is
                                            not full-service moving and there is
