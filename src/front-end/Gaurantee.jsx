        ...
        return (
            <>
                <div
                    ...
                    style={{
                        backgroundImage: `url("/assets/img/gaurantee-bg.jpg")`,
                    }}
                >
                            ...
                            <div className="col-md-12">
                                <div className="service-card-des d-flex align-items-center ">
                                    ...
                                    <div className="service-card-detail">
                                        ...
                                        <div className="des">
                                            Farenow strives to match you with
                                            the right pro for you and your home
                                            every time. If you’re not satisfied
                                            with the quality of the service you
                                            booked and paid for directly on the
                                            Farenow platform, we’ll send another
                                            pro at no extra charge for your next
                                            booking.
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="col-md-12">
                                <div className="common-heading text-center">
                                    ...
                                    <div className="sub-des">
                                        Cleaning and handyman services booked
                                        and paid for directly through the
                                        Farenow platform are performed by
                                        <br className="d-none d-md-block" />{" "}
                                        background-checked professionals who are
                                        highly rated by customers like you. And
                                        for cleaning, your favorite pro
                                        <br className="d-none d-md-block" /> can
                                        come back again and again to clean your
                                ...
                                <div className="col-md-4">
                                    <div className="team-card">
                                        ...
                                        <div className="detail-team">
                                            ...
                                            experience in housekeeping. My goal
                                            is to delight my customers by
                                            providing a deep, thorough cleaning.
                                            Dusted surfaces, baseboards, ceiling
                                            fans, and polished appliances are a
                                            big deal to me. I pay close detail
                                            to all the nooks and cranies!
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-4">
                            ...
                            <div className="col-md-12">
                                <div className="service-card-des d-flex align-items-center ">
                                    <div className="service-card-detail">
                                        ...
                                        <div className="des">
                                            In the rare event of damage, Farenow
                                            got your back. Bookings made and
                                            paid for directly on the Farenow
                                            platform are insured. Learn more
                                        </div>
                                    </div>
                                    <div className="src-image-box">
                                        <img
