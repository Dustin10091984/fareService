...
export const Cart = (props) => {
  ...
  const cartLoading = useSelector((state) => state.cartsReducer?.list.loading);
            ...
            <div className="col-md-12">
              ...
              <div className="row">
                          ...
                          <div className="cart-total cart-page d-flex align-items-center justify-content-between">
                            <div className="d-flex align-items-center justify-content">
                              <input
                                type="radio"
                                className="radio m-5"
                                checked={state?.cart_ids?.includes(item.id)}
                              ...
                              <div className="cart-img">
                                <img
                                  ...
                                  alt=""
                                  onError={(e) => {
                                    e.target.src = "/assets/img/cart-prod.jpg";
                                  }}
                                />
                              </div>
                              ...
                              <ul className="list-des d-flex align-items-center justify-content-between w-100">
                                ...
                                <li className={"d-flex justify-content-center"}>
                                  ...
                                  {((item?.id == state?.cart?.id &&
                                    ...
                                    // ></i>
                                    // <i
                                    //     className="la la-times mt-2 cart-remove-btn"
                                    //     onClick={() =>
                                    //         handleDeleteClick(
                                    //             item.id
                                    //         )
                ...
                <div className="check-box w-100 text-right">
                  ...
                  <Link to="/restaurants" className="update-cart m-1">
                    Add More Foods
                  </Link>
                  <Link to="/grocery-stores" className="update-cart m-1">
                    Add More Product
                  </Link>
      ...
      >
        ...
        >
          <div className="modal-content">
            ...
            >
              <h4 className="modal-title mt-2" id="exampleModalLongTitle">
            ...
            <div className="modal-body">
              <div className="row m-2">
                <div className="col-12">
                  <center>
                    <button className="button-common m-3" data-dismiss="modal">
                      Cancel
                    </button>
                    <button
                      onClick={() => dispatch(deleteCart(state?.cartId))}
