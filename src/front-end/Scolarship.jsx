                        ...
                        <div className="row">
                            <div className="col-12">
                                ...
                                <div className="affordable-detail mt-5 pt-5">
                                    ...
                                    <p className="des">
                                        Any student currently enrolled in high school, college, university or trade school is eligible to apply for the Farenow Scholarship.
                                ...
                                <div className="affordable-detail mt-5 pt-5">
                                    ...
                                    <p className="des">
                                        ...
                                        Host it on YouTube and be sure to include Farenow Scholarship” somewhere in the title and a link to https://www.farenow.com in the video description.
                                        Send us an e-mail at scholarships@farenow.com with your name, e-mail address, a link to your video, and the name of your educational institution.
                                    </p>
                                </div>
                                <div className="affordable-detail mt-5 pt-5">
                                    <div className="title">Deadline</div>
                                    <p className="des">
                                        The deadline for applying to the Farenow Scholarship is August 31, 2018. The winner will be notified via email by September 30, 2018. The winner will then have two weeks to respond and claim their scholarship by providing verification of their educational enrollment.
                                    </p>
                                </div>
                                <div className="affordable-detail mt-5 pt-5">
                                    <div className="title">Legal Disclaimer</div>
                                    <p className="des">
                                    Publicity: Except where prohibited, participation in the Scholarship constitutes Winner’s consent to Farenow and its respective agents’ use of Winner’s name, likeness, photograph, voice, opinions, hometown, and state for Scholarship-related and promotional purposes in any media, worldwide (with or without attribution), without further payment or consideration.
                                    </p>
                                </div>
                            </div>
                        </div>
