                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="shop-search prod-des-card d-flex align-items-center justify-content-center mx-auto">
                                    ...
                                    <Link to='/product-detail' className="button-common">Open</Link>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row">
                            <div className="col-md-3">
                                <div className="shop-left-box">
                                    <div className="title mt-5 pt-5">Recommended</div>
                            ...
                            <div className="col-md-9">
                                <div className="row">
                                    <div className="col-12">
                                        ...
                                        <form action="" className="d-flex justify-content-center mb-5 pb-5">
