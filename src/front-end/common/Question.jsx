            ...
            <>
              <div className="question">
                {state.question && state.question !== undefined
                  ? state.question.data && state.question.data.questions.length
                    ? `${
              ...
              <div className="row">
                ...
                state.question !== undefined &&
                state.question.data &&
                state.question.data.questions[state.currentStep]?.options
                  .length ? (
                  state.question.data.questions[state.currentStep].options.map(
                    (data, index) => {
                      return (
