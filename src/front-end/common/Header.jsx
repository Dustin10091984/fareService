        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12 d-flex align-items-center justify-content-between flex-wrap flex-md-nowrap">
               ...
               * Header search bar
               */}
              <div className="header-search d-none align-items-center order-2 order-md-1">
                <form action="">
                  ...
                  {state?.is_search && !!state?.subServices?.length && (
              ...
              <div className="d-flex align-items-center order-1 order-md-2">
                <div className="header-links-login">
                  <ul className="nav-l d-flex align-items-center">
                    {!state.is_loggedin && header_middle}
                    <li className="item-list">
                      {state.is_loggedin && (
                        <span
                          ref={ref}
          ...
          <div className="modal-content">
            <div className="modal-header">
              ...
              <button
                ...
                data-dismiss="modal"
                aria-label="Close"
                onClick={() => setState({ ...state, isChatOpen: false })}
              >
                <span
                  aria-hidden="true"
                  style={{
