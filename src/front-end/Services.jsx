                            ...
                            <div className="col-md-12">
                                <div className="service-card-des d-flex align-items-center ">
                                    <div className="src-image-box">
                                        <img src="/assets/img/service-caed-2.jpg" className="img-fluid" alt="image" />
                                    </div>
                                ...
                                <div className="service-card-des d-flex align-items-center ">
                                    <div className="src-image-box">
                                        <img src="/assets/img/service-caed-2-2.jpg" className="img-fluid" alt="image" />
                                    </div>
                                    <div className="service-card-detail">
                                ...
                                <div className="service-card-des d-flex align-items-center ">
                                    <div className="src-image-box">
                                        <img src="/assets/img/service-caed-2-3.jpg" className="img-fluid" alt="image" />
                                    </div>
                                    <div className="service-card-detail">
                        ...
                        <div className="row">
                            ...
                            <div className="row">
                                <div className="col-md-4">
                                    <div className="team-card">
                                        <div className="team-img">
                                            <img src="/assets/img/user1.jpg" className="img-fluid" alt="image" />
                                        </div>
                                        <div className="title">
                                            Sharonda H.
                                            </div>
                                ...
                                <div className="col-md-4">
                                    <div className="team-card">
                                        <div className="team-img">
                                            <img src="/assets/img/user2.jpg" className="img-fluid" alt="image" />
                                        </div>
                                        <div className="title">
                                            Justin R.
                                            </div>
                                ...
                                <div className="col-md-4">
                                    <div className="team-card">
                                        <div className="team-img">
                                            <img src="/assets/img/user3.jpg" className="img-fluid" alt="image" />
                                        </div>
                                        <div className="title">
                                            Milagros K.
                                            </div>
