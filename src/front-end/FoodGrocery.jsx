...
export class FoodGrocery extends Component {
    render() {
        return (
            <>
                            ...
                            <div className="col-12">
                                <div className="shop-search d-flex align-items-center justify-content-center mx-auto">
                                    <div className="header-search d-flex align-items-center justify-content-center flex-column">
                                        <div className="shop-serch-title mb-5">Search Food</div>
                                        <form action="">
                        ...
                        <div className="row">
                            <div className="col-md-3">
                                <div className="shop-left-box">
                                    ...
                                    <div className="filters-list">
                                        <label className="filter-check">North Indian Foods
                                        <input type="checkbox" checked="checked" />
                                            <span className="checkmark"></span>
                                        </label>
                                        <label className="filter-check">South Indian Foods
                                        <input type="checkbox" checked="" />
                                            <span className="checkmark"></span>
                                        </label>
                                        <label className="filter-check">American Foods
                                        <input type="checkbox" checked="" />
                                            <span className="checkmark"></span>
                                        </label>
                                        <label className="filter-check">Arabian Foods
                                        <input type="checkbox" checked="" />
                                            <span className="checkmark"></span>
                                        </label>
                                        <label className="filter-check">Bakers
                                        <input type="checkbox" checked="" />
                                            <span className="checkmark"></span>
                                        </label>
                                        <label className="filter-check">Asian
                                        <input type="checkbox" checked="" />
                                            <span className="checkmark"></span>
                                        </label>
                                        <label className="filter-check">African Food
                                        <input type="checkbox" checked="" />
                                            <span className="checkmark"></span>
                                        </label>
                                    </div>
                                    <div className="title mt-5 pt-5">Quick Filters</div>

                                    <div className="filters-list">
                                        <label className="filter-check">Non Veg
                                            <input type="checkbox" checked="checked" />
                                            <span className="checkmark"></span>
                                        </label>
                                        <label className="filter-check">Pure Veg
                                            <input type="checkbox" checked="" />
                                            <span className="checkmark"></span>
                                        </label>
                                        <label className="filter-check">Free Delivery
                                            <input type="checkbox" checked="" />
                                            <span className="checkmark"></span>
                                        </label>
                                    </div>
                            ...
                            <div className="col-md-9">
                                <div className="row">
                                    <div className="col-12">
                                        <div className="shop-left-box">
                                            <div className="title text-center">Food Store</div>
                                        </div>
                                    </div>
