                            ...
                            <div className="col-md-12">
                                <div className="moving-search-box">
                                        ...
                                        <div className="m-search-left-box mx-auto">
                                            ...
                                            <div className="mb-4 d-flex align-items-center justify-content-between">
                                                <div className="common-input">
                                                    <input
                                                        type="text"
                                                        placeholder="Your Primary Services"
                                                    />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="text-center">
                                        <button className="button-common mt-5 w-50">
                                            Place Order
                                        </button>
                                    </div>
                                    ...
                                    <div className="row pad-t">
                                        <div className="col-md-4">
                                            <div className="team-card">
                                                ...
                                                <div className="detail-team">
                                                    Make up to $22/hour/job as a
                                                    cleaner or $45/hour/job as a
                                                    handyman or $62/hour/job as
                                                    a lawn care pro. Our top
                                                    professionals make more than
                                                    $1,000 a week.
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-md-4">
                                            <div className="team-card">
                                                ...
                                                <div className="detail-team">
                                                    ...
                                                    work and how much. Build a
                                                    full schedule of your
                                                    customers or simply add a
                                        ...
                                        <div className="col-md-4">
                                            <div className="team-card">
                                                ...
                                                <div className="detail-team">
                                                    No more tracking down your
                                                    customers for payments. Your
                                                    payments are direct
                                                    deposited into your bank
                                                    account soon after the job
                                                    is complete.
                                                </div>
                                            </div>
                                        </div>
